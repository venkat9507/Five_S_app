...
import 'package:flutter_app11/added%20questions/shinequestions.dart';
import '../mainpage.dart';
String unitText;
String sectionText;
String questionText;
final sectionOrderText = 'SHINE';

class Shine extends StatefulWidget {
  @override
  _ShineState createState() => _ShineState();
}
                  ...
                  FlatButton(
                    onPressed: () async {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ShineQuestions(docid: null,),
                        ),
                      );
                    },
                    child: Container(
