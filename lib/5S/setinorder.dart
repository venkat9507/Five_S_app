...
import 'package:flutter/material.dart';
import 'package:flutter_app11/added%20questions/setinorderquestions.dart';
...
String sectionText;
String questionText;
final sectionOrderText = 'SET IN ORDER';

class setInOrder extends StatefulWidget {
  @override
  _setInOrderState createState() => _setInOrderState();
}

class _setInOrderState extends State<setInOrder> {
  int value = 1;
                  ...
                  FlatButton(
                    onPressed: () async {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SetInOrderQuestions(docid: null,),
                        ),
                      );
                    },
                    child: Container(
