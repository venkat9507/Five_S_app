...
import 'package:flutter_app11/added questions/sustainquestions.dart';

String unitText;
String sectionText;
String questionText;
final sectionOrderText = 'SUSTAIN';

class Sustain extends StatefulWidget {
  @override
  _SustainState createState() => _SustainState();
}
                  ...
                  FlatButton(
                    onPressed: () async {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SustainQuestions(docid: null,),
                        ),
                      );
                    },
                    child: Container(
