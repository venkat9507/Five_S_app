        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
                    ...
                    child: SingleChildScrollView(
                      child: ListView.builder(
                        physics: NeverScrollableScrollPhysics(),
                          ...
                          shrinkWrap: true,
                          itemBuilder: (context, index) => this._buildedRow(index)),
                    ),
                  ),
                ],
              ),
              ...
              FloatingActionButton(heroTag: 'btn 2',
                onPressed: _addItem,
                backgroundColor: Colors.white,
                child: Icon(Icons.add,color: Colors.lightGreenAccent,size: 20,),
              ),
              SizedBox(height: 10,),
              Row(mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  FlatButton(onPressed: ()async{
                    var res;
                    questions.add(questionText);
                    var result = await _Firestore.collection('Questions').add({
                      'unit': unitText,
                      'section': sectionText,
                      'question': questions,
                    }).then((value){
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => addedQuestions(docid: res),),
                    );
                  },
                    child: Container(
                        height: 50,
