...
class StandardiseQuestions extends StatefulWidget {
  final docid;
 StandardiseQuestions({this.docid});
  @override
  _StandardiseQuestionsState createState() => _StandardiseQuestionsState();
}

class _StandardiseQuestionsState extends State<StandardiseQuestions> {
