...
class SortQuestions extends StatefulWidget {
  final docid;
  SortQuestions({this.docid});
  @override
  _SortQuestionsState createState() => _SortQuestionsState();
}

class _SortQuestionsState extends State<SortQuestions> {
