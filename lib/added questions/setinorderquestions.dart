...
class SetInOrderQuestions extends StatefulWidget {
  final docid;
  SetInOrderQuestions({this.docid});
  @override
  _SetInOrderQuestionsState createState() => _SetInOrderQuestionsState();
}

class _SetInOrderQuestionsState extends State<SetInOrderQuestions> {
